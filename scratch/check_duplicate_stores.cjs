...
const options = {
  ...
  path: '/rest/v1/stores?ifood_merchant_id=eq.5810f9ac-c56e-41e3-82cc-f803f66c4529&select=id,fantasy_name,ifood_merchant_id',
  method: 'GET',
  headers: {
    'apikey': supabaseKey,
...
const req = https.request(options, (res) => {
  ...
  res.on('end', () => {
    try {
      ...
      console.log("LOJAS COM O ID IFOOD DE TESTE:");
