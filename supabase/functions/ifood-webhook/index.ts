  ...
  try {
    ...
    if (payload.action) {
      ...
      if (action === "confirmOrder") {
        ...
        // O iFood Merchant API v1.0 exige 'cancellationCode' (código numérico em string ex: "501") E 'reason' (texto descritivo)
        const finalCode = String(cancellationCode ?? "501");
        bodyData = {
          cancellationCode: finalCode,
