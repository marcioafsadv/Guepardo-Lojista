...
const supabase = createClient(
  ...
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImV2aXVrYmx1d3J3Y2Jsd2hrend6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTEyODg0NjMsImV4cCI6MjAyNjg2NDQ2M30.6iS7820V9uVpGvKz-r-r5S_S-v0V9v-S-v0V9v-S-v0'
);

async function checkPendingTransactions() {
  console.log('--- Buscando Transações Pendentes (Fixed ESM) ---');
  try {
